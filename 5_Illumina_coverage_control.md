...
```
qsub -o logs -e logs -cwd -N nucmer -V -pe smp64 1 -b yes 'nucmer -p /data/ross/mealybugs/analyses/B_viburni_2020/isabelle_old_2019/pseudococcus_viburni/5_blobtools/1_blobplot1/pviburni.clc.se.listL.fna -t 24 /data/ross/mealybugs/analyses/B_viburni_2020/1_pacbio_assembly/5_assembly_freeze_v0/p.viburni.freeze.v0.fa pviburni.clc.se.listL.p.viburni.freeze.v0.fna'
```
running on bigwig
